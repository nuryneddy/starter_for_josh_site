...
<div class="container">
  ...
  <?php get_header();?>   <!--  Tells WordPress to include header.php -->
      ...
      <section class="container-fluid articlesbg">
        <div class="container">
          <h3 class="text-centre">LATEST ARTICLES</h3>
          ...
          <div class="row">
            <div></div>
                    ...
                    <div class="col-md-4 text-center">
                      <img class="img-fluid" src="images/port3.jpg" alt=“portrait”
                      src="http://170.187.231.66/~mesh8/wp-content/themes/starter_for_josh_site/images/port1.jpg">
...
<a class= "readmore" href="#" >CONTINUE READING</a>
                ...
                <div class="col-md-4 text-center">
                  <img class="img-fluid" src="images/port4.jpg" alt=“portrait”
                  src="http://170.187.231.66/~mesh8/wp-content/themes/starter_for_josh_site/images/port2.jpg">
...
<a class= "readmore" href="#" >CONTINUE READING</a>
                ...
                <div class="col-md-4 text-center">
                  <img class="img-fluid" src="images/port5.jpg" alt=“portrait” 
                  src="http://170.187.231.66/~mesh8/wp-content/themes/starter_for_josh_site/images/port3.jpg">
